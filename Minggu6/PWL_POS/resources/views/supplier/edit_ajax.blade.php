        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input value="" type="supplier_alamat" name="supplier_alamat" id="supplier_alamat" class="form-control">
                    <small id="error-supplier_alamat" class="error-text form-text textdanger"></small>
                </div>
            </div>
