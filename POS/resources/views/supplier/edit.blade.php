    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/supplier', $supplier->supplier_id) }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <textarea class="form-control" id="supplier_alamat" name="supplier_alamat" rows="3" required>{{ old('supplier_alamat', $supplier->supplier_alamat) }}</textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    ...
                    <a class="btn btn-sm btn-default mt-1" href="{{ url('supplier') }}">Kembali</a>
                </div>
            </div>
        </form>
        @endempty
